...
Sb = cov_rows(background, center=False)
T = Sf - alpha * Sb
...
print(f"CPCA runtime: {elapsed_time:.4f} seconds")
...
result.to_csv(os.path.join(result_dir, 'cpca_mnist_latent.csv'), index=False)

# Save timing information
with open(os.path.join(result_dir, 'cpca_mnist_timing.txt'), 'w') as f:
